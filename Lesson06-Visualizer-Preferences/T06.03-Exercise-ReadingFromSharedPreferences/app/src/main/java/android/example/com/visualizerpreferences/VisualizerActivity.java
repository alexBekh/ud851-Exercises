...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        boolean showBass = true;
        if(sharedPreferences.contains(getString(R.string.pref_key_show_bass)))
            showBass = sharedPreferences.getBoolean(getString(R.string.pref_key_show_bass), true);
