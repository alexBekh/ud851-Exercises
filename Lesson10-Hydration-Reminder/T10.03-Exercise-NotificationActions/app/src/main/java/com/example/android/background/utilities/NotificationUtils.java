...
public class NotificationUtils {
    ...
    private static final int ACTION_DISMISS_NOTIFICATION_PENDING_INTENT_ID = 1567;
    private static final int ACTION_DRINK_WATER_PENDING_INTENT_ID = 5894;
    /**
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context)
    {
        ...
        return new NotificationCompat.Action(
                ...
                context.getString(R.string.action_dismiss_notification_title),
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context)
    {
        ...
        return new NotificationCompat.Action(
                ...
                context.getString(R.string.action_drink_water_title),
