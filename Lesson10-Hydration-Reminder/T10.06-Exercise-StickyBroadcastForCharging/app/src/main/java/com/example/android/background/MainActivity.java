        ...
        SharedPreferences.OnSharedPreferenceChangeListener
{
    ...
    private boolean isCharging()
    {
        ...
        else
        {
            ...
            int batteryStatus = batteryStickyIntent.getIntExtra(BatteryManager.EXTRA_STATUS, -1);
            ...
            Log.d(TAG, "isCharging: <23, isCharging=" + isCharging);
            return isCharging;
        }
        //for some reason first block always returns false and second returns true
    }
