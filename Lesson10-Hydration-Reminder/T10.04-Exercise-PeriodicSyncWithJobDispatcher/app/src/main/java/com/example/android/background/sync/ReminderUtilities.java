...
public class ReminderUtilities
{
    ...
    private static final int EXECUTE_WINDOW_SECONDS = REMINDER_INTERVAL_SECONDS;
    ...
    // Checkout https://github.com/firebase/firebase-jobdispatcher-android for an example1
    public static synchronized void scheduleChargingReminder(Context context)
    {
        ...
        Job job = dispatcher.newJobBuilder()
                ...
                .setTrigger(Trigger.executionWindow(REMINDER_INTERVAL_SECONDS,
                        REMINDER_INTERVAL_SECONDS + EXECUTE_WINDOW_SECONDS))
